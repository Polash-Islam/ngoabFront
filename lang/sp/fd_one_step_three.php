...
return [
    ...
    'nid_copy' => 'National ID Copy (PDF)',
    'passport_attachment'=> 'Passport Copy (PDF)',
    'passport_copy' => 'Passport Copy (PDF)',
    'jog_korun' => 'Add Member',
    'passport_photo' => 'Passport Size Photo (Recent)',
    ];
