...
return [
    ...
    'mother_account_details_text'=>'Main account details',
    'buro_onumodon_copy'=>'In case of change of bank account number, copy of approval letter from Bureau should be attached',
];
?>
