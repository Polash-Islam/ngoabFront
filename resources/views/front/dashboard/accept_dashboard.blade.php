                                                    ...
                                                    <div class="profile_about">
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>Name: {{ $ngo_list_all->name_of_head_in_bd }} <br>
                                                                    Address: {{ $ngo_list_all->address_of_head_office }}
                                                                    <br> Phone Number: {{ $ngo_list_all->phone }} </td>
                                                            </tr>
                                                            <tr>
                                                                <td>মোবাইল নম্বর</td>
                                                                    ...
                                                                    @else
                                                                        @foreach($name_change_list as $all_name_change_list)
                                                                            <div class="flex-grow-1 ms-3">
                                                                                ...
                                                                                <small
                                                                                    class="text-muted">তারিখ: {{ $all_name_change_list->created_at->format('d-M-Y')}}
                                                                                    &
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="ms-3 flex-grow-1">
                                                                                <h6 class="fs-15 mb-0">
                                                                                    <a target="_blank"
                                                                                       href="{{ route('renewFileDownloadFromView', ['title' =>'foregin_pdf', 'id' =>$ngo_list_all->id] )}}">বিগত
                                                                                        ১০ (দশ) বছরে বিদেশী অনুদান
                                                                                        ব্যবস্থাপনা কার্যক্রমের বিশদ
                                                                                        বিবরণ (প্রকল্প অনুযায়ী
                                                                                        সারসংক্ষেপ সংযুক্ত করা হবে)</a>
                                                                                </h6>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="ms-3 flex-grow-1">
                                                                                <h6 class="fs-15 mb-0">
                                                                                    <a target="_blank"
                                                                                       href="{{ route('renewFileDownloadFromView', ['title' =>'annual_file', 'id' =>$ngo_list_all->id] )}}">সংস্থার
                                                                                        সম্ভাব্য/প্রত্যাশিত বার্ষিক
                                                                                        বাজেট (উৎসসহ)</a>
                                                                                </h6>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="ms-3 flex-grow-1">
                                                                                <h6 class="fs-15 mb-0">
                                                                                    <a target="_blank"
                                                                                       href="{{ route('renewFileDownloadFromView', ['title' =>'copy_of_chalan', 'id' =>$ngo_list_all->id] )}}">নিবন্ধন
                                                                                        ফি ও ভ্যাট পরিশোধ করা হয়েছে
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="ms-3 flex-grow-1">
                                                                                <h6 class="fs-15 mb-0">
                                                                                    <a target="_blank"
                                                                                       href="{{ route('renewFileDownloadFromView', ['title' =>'due_vat_pdf', 'id' =>$ngo_list_all->id] )}}">তফসিল
                                                                                        -১ এ বর্ণিত যেকোন ফি এর ভ্যাট
                                                                                        বকেয়া থাকলে পরিশোধ হয়েছে কিনা
                                                                                        (চালানের কপি সংযুক্ত করতে
                                                                                        হবে)</a>
                                                                                </h6>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div class="ms-3 flex-grow-1">
                                                                                    <h6 class="fs-15 mb-0">
                                                                                        <a target="_blank"
                                                                                           href="{{ route('renewFileDownloadFromView', ['title' =>'change_ac_number', 'id' =>$ngo_list_all->id] )}}">ব্যাংক
                                                                                            হিসাব নম্বর পরিবর্তন হয়ে
                                                                                            থাকলে ব্যুরোর অনুমোদনপত্রের
                                                                                            কপি </a>
                                                                                    </h6>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <td>
                                                                                <div class="d-flex align-items-center">
                                                                                    ...
                                                                                    <div class="ms-3 flex-grow-1">
                                                                                        <h6 class="fs-15 mb-0">
                                                                                            <a target="_blank"
                                                                                               href="{{ route('deleteRenewalFileDownload', ['title' =>'registration_renewal_fee', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                                নিবন্ধন নবায়ন ফি
                                                                                                জমাদানের চালানের
                                                                                                মূলকপিসহ সত্যায়িত
                                                                                                অনুলিপি
                                                                            ...
                                                                            <td>
                                                                                <div class="d-flex align-items-center">
                                                                                    ...
                                                                                    <div class="ms-3 flex-grow-1">
                                                                                        <h6 class="fs-15 mb-0">
                                                                                            <a target="_blank"
                                                                                               href="{{ route('deleteRenewalFileDownload', ['title' =>'nid_and_image_of_executive_committee_members', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                                নির্বাহী কমিটির সদস্যদের
                                                                                                পাসপোর্ট সাইজের ছবিসহ
                                                                                                জাতীয় পরিচয়পত্রে
                                                                                                সত্যায়িত অনুলিপি
                                                                                            </a>
                                                                                        </h6>
                                                                            ...
                                                                            <td>
                                                                                <div class="d-flex align-items-center">
                                                                                    ...
                                                                                    <div class="ms-3 flex-grow-1">
                                                                                        <h6 class="fs-15 mb-0">
                                                                                            <a target="_blank"
                                                                                               href="{{ route('deleteRenewalFileDownload', ['title' =>'committee_members_list', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                                নিবন্ধনকালীন দাখিলকৃত
                                                                                                সাধারণ ও নির্বাহী কমিটির
                                                                                                তালিকা এবং বর্তমান
                                                                                                সাধারণ সদস্য ও নির্বাহী
                                                                                                কমিটির তালিকা
                                                                                            </a>
                                                                                        </h6>
                                                                                    </div>
                                                                            ...
                                                                            <td>
                                                                                <div class="d-flex align-items-center">
                                                                                    ...
                                                                                    <div class="ms-3 flex-grow-1">
                                                                                        <h6 class="fs-15 mb-0">
                                                                                            <a target="_blank"
                                                                                               href="{{ route('deleteRenewalFileDownload', ['title' =>'approval_of_executive_committee', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                                উপস্থিত সাধারণ সদস্যদের
                                                                                                উপস্থিতির স্বাক্ষরিত
                                                                                                তালিকাসহ নির্বাহী কমিটি
                                                                                                অনুমোদন সংক্রান্ত সাধারণ
                                                                                                সভার কার্যবিবরণীর
                                                                                                সত্যায়িত অনুলিপি
                                                                                            </a>
                                                                                        </h6>
                                                                            ...
                                                                            <td>
                                                                                <div class="d-flex align-items-center">
                                                                                    ...
                                                                                    <div class="ms-3 flex-grow-1">
                                                                                        <h6 class="fs-15 mb-0">
                                                                                            <a target="_blank"
                                                                                               href="{{ route('deleteRenewalFileDownload', ['title' =>'trustees', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                                বোর্ড অব ডিরেক্টরস
                                                                                                /বোর্ড অব ট্রাস্টিজ
                                                                                                তালিকা (সংশ্লিষ্ট দেশের
                                                                                                পিস অব জাস্টিস কর্তৃক
                                                                                                নোটারীকৃত /সত্যায়িত )
                                                                                            </a>
                                                                                        </h6>
                                                                                    </div>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="ms-3 flex-grow-1">
                                                                                    <h6 class="fs-15 mb-0">
                                                                                        <a target="_blank"
                                                                                           href="{{ route('deleteRenewalFileDownload', ['title' =>'laws_or_constitution', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                            অন্য কোনো আইনে নিবন্ধিত হলে
                                                                                            সংশিষ্ট কতৃপক্ষের অনুমোদিত
                                                                                            নির্বাহী কমিটির তালিকার
                                                                                            সত্যায়িত অনুলিপি
                                                                                        </a>
                                                                                    </h6>
                                                                                </div>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <div class="ms-3 flex-grow-1">
                                                                                    <h6 class="fs-15 mb-0">
                                                                                        ...
                                                                                        <a target="_blank"
                                                                                           href="{{ route('deleteRenewalFileDownload', ['title' =>'work_procedure', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                            প্রাথমিক নিবন্ধনকারী
                                                                                            কতৃপক্ষের অনুমোদিত
                                                                                            গঠনতন্ত্রের সত্যায়িত অনুলিপি
                                                                                        </a>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="ms-3 flex-grow-1">
                                                                                    <h6 class="fs-15 mb-0">
                                                                                        <a target="_blank"
                                                                                           href="{{ route('deleteRenewalFileDownload', ['title' =>'last_ten_years', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                            সংস্থার বিগত ১০(দশ ) বছরের
                                                                                            অডিট রিপোর্ট এবং বার্ষিক
                                                                                            প্রতিবেদনের সত্যায়িত অনুলিপি
                                                                                        </a>
                                                                                    </h6>
                                                                                </div>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="ms-3 flex-grow-1">
                                                                                    <h6 class="fs-15 mb-0">
                                                                                        <a target="_blank"
                                                                                           href="{{ route('deleteRenewalFileDownload', ['title' =>'registration_certificate', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                            সংস্থার মূল কার্যালয়ের
                                                                                            নিবন্ধনপত্রের (সংশ্লিষ্ট
                                                                                            দেশের নোটারীকৃত /সত্যায়িত )
                                                                                            অনুলিপি
                                                                                        </a>
                                                                                    </h6>
                                                                                </div>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="ms-3 flex-grow-1">
                                                                                    <h6 class="fs-15 mb-0">
                                                                                        <a target="_blank"
                                                                                           href="{{ route('deleteRenewalFileDownload', ['title' =>'registration_or_renewal_certificate', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                            সর্বশেষ নিবন্ধন /নবায়ন
                                                                                            সনদপত্রের সত্যায়িত অনুলিপি
                                                                                        </a>
                                                                                    </h6>
                                                                                </div>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="ms-3 flex-grow-1">
                                                                                    <h6 class="fs-15 mb-0">
                                                                                        <a target="_blank"
                                                                                           href="{{ route('deleteRenewalFileDownload', ['title' =>'right_to_information_act', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                            Right To Information Act-
                                                                                            ২০০৯ - এর আওতায় - Focal
                                                                                            Point নিয়োগ করত:ব্যুরোকে
                                                                                            অবহিতকরণ পত্রের অনুলিপি
                                                                                        </a>
                                                                                    </h6>
                                                                                </div>
                                                                            </td>
                                                                                ...
                                                                                <td>
                                                                                    <div class="ms-3 flex-grow-1">
                                                                                        <h6 class="fs-15 mb-0">
                                                                                            ...
                                                                                            <a target="_blank"
                                                                                               href="{{ route('deleteRenewalFileDownload', ['title' =>'fee_if_changed', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                                সংস্থার গঠনতন্ত্র
                                                                                                পরিবর্তন হয়ে থাকলে
                                                                                                নির্ধারিত ফি সহ তার
                                                                                                সত্যায়িত অনুলিপি
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <div class="ms-3 flex-grow-1">
                                                                                        <h6 class="fs-15 mb-0">
                                                                                            <a target="_blank"
                                                                                               href="{{ route('deleteRenewalFileDownload', ['title' =>'primary_registering_authority', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                                প্রাথমিক নিবন্ধনকারী
                                                                                                কতৃপক্ষের অনুমোদিতো
                                                                                                গঠনতন্ত্রের সত্যায়িত কপি
                                                                                            </a>
                                                                                        </h6>
                                                                                    </div>
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="ms-3 flex-grow-1">
                                                                                        <h6 class="fs-15 mb-0">
                                                                                            <a target="_blank"
                                                                                               href="{{ route('deleteRenewalFileDownload', ['title' =>'clean_copy_of_the_constitution', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                                সংস্থার চেয়ারম্যান ও
                                                                                                সেক্রেটারি কর্তৃক যৌথ
                                                                                                স্বাক্ষরিত গঠনতন্ত্র
                                                                                                পরিচ্ছন্ন কপি
                                                                                            </a>
                                                                                        </h6>
                                                                                    </div>
                                                                                ...
                                                                                <td>
                                                                                    <div class="ms-3 flex-grow-1">
                                                                                        <h6 class="fs-15 mb-0">
                                                                                            ...
                                                                                            <a target="_blank"
                                                                                               href="{{ route('deleteRenewalFileDownload', ['title' =>'payment_of_change_fee', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                                গঠনতন্ত্রের কোন ধারা,
                                                                                                উপধারা পরিবর্তন ফি জমা
                                                                                                প্রদানের চালানের মূলকপি
                                                                                            </a>
                                                                                        </h6>
                                                                                    </div>
                                                                                </td>
                                                                                ...
                                                                                <td>
                                                                                    <div class="ms-3 flex-grow-1">
                                                                                        <h6 class="fs-15 mb-0">
                                                                                            ...
                                                                                            <a target="_blank"
                                                                                               href="{{ route('deleteRenewalFileDownload', ['title' =>'section_sub_section_of_the_constitution', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                                গঠনতন্ত্রের কোন ধারা,
                                                                                                উপধারা পরিবর্তন ও
                                                                                                সংযোজনের বিষয়ে সাধারণ
                                                                                                সভার কার্যবিবরণীর
                                                                                                সত্যায়িত কপি
                                                                                            </a>
                                                                                        </h6>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div class="ms-3 flex-grow-1">
                                                                                        <h6 class="fs-15 mb-0">
                                                                                            <a target="_blank"
                                                                                               href="{{ route('deleteRenewalFileDownload', ['title' =>'previous_constitution', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                                পূর্ব গঠনতন্ত্র ও
                                                                                                বর্তমান গঠনতন্ত্রের
                                                                                                তুলনামূলক বিবরণী (প্রতি
                                                                                                পাতায় সভাপতি ও সম্পাদকের
                                                                                                যৌথ স্বাক্ষরসহ)
                                                                                            </a>
                                                                                        </h6>
                                                                                    </div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <div class="ms-3 flex-grow-1">
                                                                                        <h6 class="fs-15 mb-0">
                                                                                            <a target="_blank"
                                                                                               href="{{ route('deleteRenewalFileDownload', ['title' =>'organization_if_unchanged', 'id' =>$ngoOtherDocListsFirst->id]) }}">
                                                                                                সংস্থার গঠনতন্ত্র
                                                                                                পরিবর্তন না হয়ে থাকলে
                                                                                                'পরিবর্তন হয়নি' মর্মে
                                                                                                প্রত্যয়ন কপি (সংশ্লিষ্ট
                                                                                                দেশের পিস অব জাস্টিস
                                                                                                কর্তৃক নোটারীকৃত
                                                                                                /সত্যায়িত
                                                                                                )
                                                                                            </a>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="ms-3 flex-grow-1">
                                                                                <h6 class="fs-15 mb-0">
                                                                                    <a target="_blank"
                                                                                       href="{{ route('formOnePdf',['main_id'=>$ngo_list_all->user_id,'id'=>'plan']) }}">পরিচালন
                                                                                        পরিকল্পনা</a>
                                                                                </h6>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="ms-3 flex-grow-1">
                                                                                <h6 class="fs-15 mb-0"><a
                                                                                        target="_blank"
                                                                                        href="{{ route('formOnePdf',['main_id'=>$ngo_list_all->user_id,'id'=>'treasury_bill']) }}">চালানের
                                                                                        কপি</a>
                                                                                </h6>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="ms-3 flex-grow-1">
                                                                                <h6 class="fs-15 mb-0"><a
                                                                                        target="_blank"
                                                                                        href="{{ route('formOnePdf',['main_id'=>$ngo_list_all->user_id,'id'=>'treasury_bill']) }}">ট্রেজারি
                                                                                        চালানের মূলকপি</a>
                                                                                </h6>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div class="ms-3 flex-grow-1">
                                                                                    <h6 class="fs-15 mb-0"><a
                                                                                            target="_blank"
                                                                                            href="{{ route('sourceOfFund',$all_get_all_source_of_fund_data->id ) }}">সম্ভাব্য
                                                                                            দাতার কাছ থেকে প্রতিশ্রুতির
                                                                                            চিঠি(দাতা সংস্থার নাম)</a>
                                                                                    </h6>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div class="ms-3 flex-grow-1">
                                                                                    <h6 class="fs-15 mb-0"><a
                                                                                            target="_blank"
                                                                                            href="{{ route('ngoMemberDocument',$all_get_all_source_of_fund_data->id ) }}">সাধারণ
                                                                                            সদস্যদের
                                                                                            নথি {{ App\Http\Controllers\NGO\CommonController::englishToBangla($key+1) }}</a>
                                                                                    </h6>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                ...
                                                                                <div class="ms-3 flex-grow-1">
                                                                                    <h6 class="fs-15 mb-0"><a
                                                                                            target="_blank"
                                                                                            href="{{ route('otherPdfFromFDOneForm',$all_get_all_source_of_fund_data->id ) }}">অন্যান্য
                                                                                            পিডিএফ
                                                                                            কপি {{ App\Http\Controllers\NGO\CommonController::englishToBangla($key+1) }}</a>
                                                                                    </h6>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                        ...
                                        <div class="card-body">
                                            <form method="post" action="{{ route('register.update') }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" value="{{ Auth::user()->user_name }}"
                                                ...
                                                <div class="mb-3">
                                                    <label for="exampleInputEmail1"
                                                           class="form-label">{{ trans('header.email')}}</label>
                                                    <input type="email" value="{{ Auth::user()->user_email }}"
                                                           class="form-control" name="email" id=""
                                                           aria-describedby="emailHelp">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="exampleInputPassword1"
                                                           class="form-label">{{ trans('header.password')}}</label>
                                                    <input type="password" class="form-control" name="password" id="">
                                                </div>

                                                <div class="mb-3">
                                                    <label for="exampleInputPassword1" class="form-label">প্রোফাইল
                                                        ছবি</label>
