...
@endif
            ...
            <div class="mb-3">
                ...
                <input type="text" data-parsley-required value="{{ $get_all_data_1->tele_phone_number }}"  name="phone_new" class="form-control" id="">
            </div>
            <div class="mb-3">
                <label for="" class="form-label">মোবাইল নম্বর <span class="text-danger">*</span> </label>
                <input type="text" value="{{ $get_all_data_1->phone }}" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                type = "number"
            ...
            <div class="mb-3">
                ...
                <input type="email" value="{{ $get_all_data_1->email }}" data-parsley-required  name="email_new" class="form-control" id="">
            </div>

            <div class="mb-3">
                <label for=""  class="form-label">ওয়েবসাইট <span class="text-danger">*</span> </label>
                <input type="text" data-parsley-required value="{{ $get_all_data_1->web_site_name ?? 'www.abc.com' }}"  name="web_site_name" class="form-control" id="">
            </div>
...
@if($get_country_type == 'Foreign')
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{ $get_all_data_1->nationality ?? 'Bangladeshi' }}"  data-parsley-required name="nationality" class="form-control" id="">
            </div>
...
$ngoType =  DB::table('ngo_type_and_languages')->where('user_id',Auth::user()->id)
 ->value('ngo_type');
            ...
            {{-- <div class="mb-3">
                          ...
                          <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <h5 class="form_middle_text">
                                        {{ trans('fd_one_step_one.songstha_prodhan_info_text') }}
                                    </h5>
                                </div>
                                ...
                                <label for="" class="form-label">{{ trans('mview.ttTwo')}}: <span class="text-danger">*</span></label>
                                     <input type="text" data-parsley-required  name="chief_name" value="{{ $get_all_data_1->chief_name }}"  class="form-control" id="mainName" placeholder="{{ trans('mview.ttTwo')}}">
                                </div>
 ...
 <div class="mb-3">
    ...
    <div class="mb-3">
        <label for="" class="form-label mt-3">{{ trans('mview.ttThree')}}: <span class="text-danger">*</span></label>
        <input type="text" data-parsley-required  name="chief_desi" value="{{ $get_all_data_1->chief_desi }}"  class="form-control"  placeholder="{{ trans('mview.ttThree')}}">
    </div>
...
<br>
        <input type="hidden"  name="image_base64">
        <div class="croppedInput mt-2">
            <img src="{{asset('/')}}{{ $get_all_data_1->digital_signature }}" style="width: 200px;" class="show-image">
        </div>
        <!-- new code for image cropper start --->
        @include('front.signature_modal.sign_main_modal')
        <!-- new code for image cropper end -->
    ...
    <div class="mb-3">
        ...
        <input type="hidden"  name="image_seal_base64">
        <div class="croppedInputss mt-2">
            <img src="{{asset('/')}}{{ $get_all_data_1->digital_seal }}" style="width: 200px;" class="show-image">
        </div>
        <!-- new code for image cropper start --->
        @include('front.signature_modal.seal_main_modal')
        <!-- new code for image cropper end -->
...
@endif
            ...
            $get_country_type = DB::table('ngo_type_and_languages')->where('user_id',Auth::user()->id)->value('ngo_type');
                                            ...
                                            <div class="mb-3">
                                                <label for=""  class="form-label">ওয়েবসাইট <span class="text-danger">*</span> </label>
                                                <input type="text" data-parsley-required value="{{ $get_all_data_new_first->web_site_name ?? 'www.abc.com' }}"  name="web_site_name" class="form-control" id="">
                                            </div>
            ...
            <div class="mb-3">
                <label for="" class="form-label">{{ trans('fd_one_step_one.nn')}} <span class="text-danger">*</span> </label>
                <input type="text"  data-parsley-required name="nationality" value="{{ $get_all_data_new_first->nationality ?? 'Bangladeshi' }}" class="form-control" id="">
            </div>
