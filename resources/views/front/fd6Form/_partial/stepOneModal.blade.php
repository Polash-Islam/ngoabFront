                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 mb-3" id="cityDiv0">
                                ...
                                <select name="city_corparation_name" class="form-control city_corparation_name"
                                        id="city_corparation_name0">
                            ...
                            <div class="col-lg-4 mb-3">
                                ...
                                <select name="prokolpoType" class="form-control " id="prokolpoType0"
                                    ...
                                    @foreach($projectSubjectList as $projectSubjectLists)
                                        <option
                                            value="{{ $projectSubjectLists->id }}">{{ $projectSubjectLists->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-lg-4 mb-3">
                                <label for="" class="form-label">বরাদ্দকৃত বাজেট<span
                                        class="text-danger">*</span></label>
                                <input type="text" name="allocated_budget" class="form-control" id="allocated_budget0"
                                       placeholder="">
                            </div>
                            <div class="col-lg-4 mb-3">
                                <label for="" class="form-label">মোট উপকারভোগীর সংখ্যা<span class="text-danger">*</span></label>
                                <input type="text" name="beneficiaries_total" class="form-control"
                                       id="beneficiaries_total0" placeholder="">
                            </div>
