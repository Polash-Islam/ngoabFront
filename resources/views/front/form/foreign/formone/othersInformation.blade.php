  ...
  <b>{{ $filename.'.'.$extension }}</b>
                        ...
                        @else
                            ...
                            <div class="mb-3 d-none">
                                ...
                                <input class="form-control"  value="{{ $getFormOneData->treasury_number ?? '12345678' }}" name="treasury_number" type="text" id="">
                            </div>
...
?>
                            ...
                            <div class="mb-3 d-none">
                                ...
                                <input class="form-control" required name="vat_invoice_number" value="{{ $getFormOneData->vat_invoice_number ?? '987654321' }}" type="text" id="">
                            </div>
                                                      ...
                                                      <div class="mb-3">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-sm-12">
                                                                <div class="mb-3">
                                                                    <label for="" class="form-label">{{ trans('fd_one_step_four.account_number')}}</label>
                                                                    <input type="text" value=""  name="account_number" class="form-control" id="">
